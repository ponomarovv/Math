...
ALTER TABLE [dbo].[Topics] DROP CONSTRAINT [FK_Answers_Questions_QuestionId]
GO
...
ALTER TABLE [dbo].[QuizTopic] DROP CONSTRAINT [FK_QuizTopic_Topics_TopicsId]
GO

ALTER TABLE [dbo].[QuizTopic] DROP CONSTRAINT [FK_QuizTopic_Quizzes_QuizzesId]
GO

/****** Object:  Table [dbo].[QuizTopic]    Script Date: 22-May-23 00:35:33  ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[QuizTopic]') AND type in (N'U'))
DROP TABLE [dbo].[QuizTopic]
GO
...
ALTER TABLE [dbo].[QuizTopic]  WITH CHECK ADD  CONSTRAINT [FK_QuizTopic_Quizzes_QuizzesId] FOREIGN KEY([QuizzesId])
REFERENCES [dbo].[Quizzes] ([Id])
ON DELETE CASCADE
GO

ALTER TABLE [dbo].[QuizTopic] CHECK CONSTRAINT [FK_QuizTopic_Quizzes_QuizzesId]
GO

ALTER TABLE [dbo].[QuizTopic]  WITH CHECK ADD  CONSTRAINT [FK_QuizTopic_Topics_TopicsId] FOREIGN KEY([TopicsId])
REFERENCES [dbo].[Topics] ([Id])
ON DELETE CASCADE
GO

ALTER TABLE [dbo].[QuizTopic] CHECK CONSTRAINT [FK_QuizTopic_Topics_TopicsId]
GO
